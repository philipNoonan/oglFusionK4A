...
private:
	...
	void updateFrames(k4a::image& depthImage, k4a::image& colorImage, k4a::image& infraImage, k4a::calibration cal);
	...
	glm::vec2 topRight = glm::vec2(640, 576);
